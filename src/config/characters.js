...
export const CHARACTERS = {
  ignis: {
    ...
    moves: {
      ...
      exSpecial1: {
        name: 'EX 烈焰角斗',
        damage: 195, startup: 6, active: 6, recovery: 12,
        hitstun: 25, blockstun: 15, knockback: 14, element: true, isEX: true,
        hitboxes: [{ x: 20, y: -65, w: 100, h: 70 }],
        moveForward: 150,
      },
      exSpecial2: {
        name: 'EX 火焰冲刺',
        damage: 165, startup: 4, active: 5, recovery: 10,
        hitstun: 22, blockstun: 14, knockback: 12, element: true, isEX: true,
        hitboxes: [{ x: 0, y: -45, w: 130, h: 50 }],
        moveForward: 260,
      },
    },
  },
  ...
  lingShuang: {
    ...
    moves: {
      ...
      exSpecial1: {
        name: 'EX 寒冰掌',
        damage: 180, startup: 3, active: 8, recovery: 10,
        hitstun: 28, blockstun: 18, knockback: 12, element: true, isEX: true,
        hitboxes: [{ x: 30, y: -55, w: 90, h: 60 }],
        moveForward: 80,
      },
      exSpecial2: {
        name: 'EX 冰柱突刺',
        damage: 150, startup: 7, active: 6, recovery: 12,
        hitstun: 25, blockstun: 16, knockback: 16, element: true, isEX: true,
        hitboxes: [{ x: 0, y: -80, w: 150, h: 80 }],
        moveForward: 0,
      },
    },
  },
  ...
  neo: {
    ...
    moves: {
      ...
      exSpecial1: {
        name: 'EX 雷光斩',
        damage: 150, startup: 2, active: 7, recovery: 8,
        hitstun: 24, blockstun: 14, knockback: 13, element: true, isEX: true,
        hitboxes: [{ x: 20, y: -60, w: 110, h: 65 }],
        moveForward: 200,
      },
      exSpecial2: {
        name: 'EX 影分身突',
        damage: 135, startup: 2, active: 8, recovery: 10,
        hitstun: 22, blockstun: 12, knockback: 10, element: true, isEX: true,
        hitboxes: [{ x: 0, y: -50, w: 140, h: 55 }],
        moveForward: 300,
      },
    },
  },
